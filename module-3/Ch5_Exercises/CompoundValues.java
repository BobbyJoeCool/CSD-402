...
and so on.
Write a program that prompts the user to enter an amount (e.g., 100.56), the annual interest rate (e.g., 5.25), and the number of months (e.g., 6) then displays the amount in the savings account after the given month.
*/
