...
Hint: A point is in the circle if its distance to (0, 0) is less than or equal to 10. The formula for computing the distance is sqrt((x2−x1)^2+(y2−y1)^2). Test your program to cover all cases.
*/
